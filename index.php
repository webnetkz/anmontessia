	...
	<footer id="footer">
		<div class="component" style="visibility: hidden;">
			<div>
				...
				<div class="h like-img"  onclick="localStorage.setItem('l2', 1);  updateFavorites();  updateElementsFavorites('a2', 'l2');">
		...
		<div class="component" style="visibility: hidden;">
			...
			<div>
				...
				<div class="h like-img" style="margin-left: 50px; margin-top: -100px;" onclick="localStorage.setItem('l3', 1);  updateFavorites();  updateElementsFavorites('a3', 'l3');">
					<img src="/public/img/likeWhite.png" style="width: 40px;">
				</div>
			</div>
		</div>
